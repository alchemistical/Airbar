...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex h-full w-64 flex-col bg-sidebar text-sidebar-foreground shadow-lg",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-1 flex-col p-6", className)}
    {...props}
  />
));
...
>(({ className, isActive, ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      isActive
        ? "bg-sidebar-primary bg-opacity-20 text-sidebar-foreground"
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("mt-8 border-t border-sidebar-border pt-8", className)}
    {...props}
  />
));
