...
export default function DisputeList() {
  ...
  const closedDisputes = filteredDisputes.filter(d =>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage and resolve delivery issues
          </p>
        </div>
  ...
  function DisputeCard({ dispute }: { dispute: Dispute }) {
    ...
    const isUrgent =
      isOverdue(dispute.firstReplyDue) && dispute.status === "open";
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                <div
                  className={`p-2 rounded-lg ${getStatusColor(dispute.status).split(" ")[0]}`}
                >
          ...
          <CardContent>
            ...
            {isUrgent && (
              <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">
                ...
                Response overdue - please respond immediately to avoid
                escalation
              </div>
            )}
          </CardContent>
