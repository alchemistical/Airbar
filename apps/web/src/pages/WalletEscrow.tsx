...
export default function WalletEscrow() {
  ...
  const filteredItems = mockEscrowItems
    .filter(item => {
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case "eta":
          return (
            new Date(a.deliveryEta).getTime() -
            new Date(b.deliveryEta).getTime()
          );
        default: // newest
          return (
  ...
  const totalEscrowAmount = mockEscrowItems.reduce(
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Monitor funds held in escrow during delivery
              </p>
            </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="space-y-1">
                    <li>
                      • Funds are locked in escrow when a delivery is confirmed
                    </li>
                    <li>
                      • Money is released automatically when delivery conditions
                      are met
                    </li>
                    <li>
                      • Disputed deliveries require manual review by support
                      team
                    </li>
                    <li>
                      • Released funds appear in your available balance within
                      24 hours
                    </li>
                  </ul>
                </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          ETA: {new Date(item.deliveryEta).toLocaleDateString()}
                        </span>
                      </div>
