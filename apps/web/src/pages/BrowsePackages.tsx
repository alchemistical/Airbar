...
export default function BrowsePackages() {
  ...
  const filteredPackages = packages.filter(pkg => {
    ...
    return (
      (!searchFrom ||
        pkg.fromCity.toLowerCase().includes(searchFrom.toLowerCase())) &&
      (!searchTo ||
        pkg.toCity.toLowerCase().includes(searchTo.toLowerCase())) &&
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Find packages that need delivery and earn money on your trips
        </p>
      </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  value={weightRange[0]}
                  onChange={e =>
                    setWeightRange([+e.target.value, weightRange[1]])
                  }
                  className="w-20"
                  min="0"
                />
                ...
                <Input
                  ...
                  value={weightRange[1]}
                  onChange={e =>
                    setWeightRange([weightRange[0], +e.target.value])
                  }
                  className="w-20"
                  min={weightRange[0]}
                />
            ...
            <div className="flex items-center space-x-2 mt-6">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  setVerifiedSendersOnly(checked as boolean)
                }
              />
              <label
                htmlFor="verified"
      ...
      <div className="mb-4 flex items-center justify-between">
        <p className="text-gray-600">
          Showing {filteredPackages.length} available package
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <Badge
                      className={cn("text-xs", getUrgencyColor(pkg.urgency))}
                    >
                      {pkg.urgency.charAt(0).toUpperCase() +
                        pkg.urgency.slice(1)}
                    </Badge>
