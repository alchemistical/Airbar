  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer:
        "Our smart matching system automatically connects parcel requests with travelers going to the same destination. When you post a trip, we'll show you relevant package requests along your route. You can accept or decline each match based on your preferences.",
      category: "general",
    ...
    },
    {
      ...
      answer:
        "Payment is released automatically once the recipient confirms successful delivery. Funds typically appear in your wallet within 24 hours. You can withdraw earnings to your bank account or keep them for future shipments.",
      category: "payments",
    ...
    },
    {
      ...
      answer:
        "All packages are covered by our protection policy. If a parcel is lost or damaged during transit, both sender and traveler should report it immediately. We'll investigate and provide compensation based on the declared value.",
      category: "general",
    ...
    },
    {
      ...
      answer:
        "You can report any issues through your order details page or by contacting support directly. We take all reports seriously and will investigate promptly to ensure platform safety.",
      category: "account",
    ...
    },
    {
      ...
      answer:
        "Escrow is our secure payment system that holds funds until delivery is confirmed. When a sender posts a package, payment is held in escrow. Once delivery is confirmed by the recipient, funds are released to the traveler.",
      category: "escrow",
    ...
    },
    {
      ...
      answer:
        "You can cancel trips or package requests before they're matched. Go to your dashboard, find the item you want to cancel, and click the cancel button. Note that cancellation policies may apply for matched items.",
      category: "general",
    ...
    },
    {
      ...
      answer:
        "After each completed delivery, both travelers and senders can rate each other on a 5-star scale. Ratings help build trust in the community and influence matching preferences.",
      category: "ratings",
    ...
    },
    {
      ...
      answer:
        "Prohibited items include hazardous materials, illegal substances, weapons, and perishable goods. Check our terms of service for the complete list of restricted items.",
      category: "general",
    ...
    },
    {
      ...
      answer:
        "Complete your KYC verification by uploading a government ID and proof of address. Verified travelers receive higher priority in matching and can carry higher-value packages.",
      category: "traveler",
    ...
    },
    {
      ...
      answer:
        "Standard packages can weigh up to 20kg (44lbs) and measure max 60cm x 40cm x 30cm. Larger packages require special approval and may incur additional fees.",
      category: "sender",
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-airbar-black">
            Help & Support
          </h1>
            ...
            >
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Tell us about your issue and we'll get back to you as soon
                    as possible.
                  </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="flex-1">
                      <span className="text-sm text-gray-600">
                        {ticketForm.attachment
                          ...
                          : "Drag files here or click to upload (optional)"}
                      </span>
            ...
            <Card className="rounded-xl mt-6">
              ...
              <CardContent className="space-y-3">
                ...
                <div
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:support@airbar.app")
                  }
                >
                ...
                <div
                  className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
                  onClick={() =>
                    window.open("https://t.me/airbarsupport", "_blank")
                  }
                >
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-start justify-between">
                                      ...
                                      <div className="flex items-center space-x-2 ml-4">
                                        <Badge
                                          variant="secondary"
                                          className={`text-xs rounded-full ${roleLabel.color}`}
                                        >
                                          {roleLabel.label}
                                        </Badge>
                                        <Badge
                      ...
                      <div className="divide-y">
                        {supportTickets.map(ticket => {
                          ...
                          return (
                            <div
                              key={ticket.id}
                              className={`p-6 border-l-4 ${getPriorityColor(ticket.priority)} hover:bg-gray-50 cursor-pointer`}
                            >
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
