...
export default function WalletReferrals() {
  ...
  const totalBonusEarned = mockBonuses.reduce(
    (sum, bonus) => sum + bonus.amount,
    0
  );
  const pendingBonuses = mockBonuses
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Earn bonuses by inviting friends to Airbar
            </p>
          </div>
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>
                  • Share your link with friends who want to become travelers
                </li>
