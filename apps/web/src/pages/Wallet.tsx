...
export default function Wallet() {
  ...
  const filteredTransactions = mockTransactions.filter(transaction => {
    ...
    if (activeTab === "earnings")
      return (
        transaction.type === "delivery-earning" ||
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Track your earnings, withdrawals, and financial activity
            </p>
          </div>
        ...
        >
          <Link href="/dashboard/wallet/withdrawals">
            <AnimatedCard
              variant="interactive"
              className="bg-gradient-to-br from-green-500 to-emerald-600 text-white hover:from-green-600 hover:to-emerald-700 transition-all duration-300"
            >
          ...
          <Link href="/dashboard/wallet/escrow">
            <AnimatedCard
              variant="interactive"
              className="bg-gradient-to-br from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 transition-all duration-300"
            >
              <CardContent className="p-6 text-center">
                <Shield className="h-8 w-8 mx-auto mb-3" />
                <h3 className="font-semibold text-lg mb-1">View Escrow</h3>
                <p className="text-blue-100 text-sm">Funds held safely</p>
              </CardContent>
            </AnimatedCard>
          </Link>
          ...
          <Link href="/dashboard/wallet/transactions">
            <AnimatedCard
              variant="interactive"
              className="bg-gradient-to-br from-purple-500 to-indigo-600 text-white hover:from-purple-600 hover:to-indigo-700 transition-all duration-300"
            >
              <CardContent className="p-6 text-center">
                <Eye className="h-8 w-8 mx-auto mb-3" />
                <h3 className="font-semibold text-lg mb-1">All Transactions</h3>
                <p className="text-purple-100 text-sm">Complete history</p>
              </CardContent>
            </AnimatedCard>
          </Link>
        </motion.div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Monitor funds held during delivery
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage payout methods and history
                    </p>
                  </div>
                </div>
              </CardContent>
