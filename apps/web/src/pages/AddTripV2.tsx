...
const formSchema = z
  .object({
    ...
    spaceAvailable: z
      .number()
      .min(1, "Available space is required")
      .max(50, "Maximum 50kg"),
    ...
    acceptableTypes: z
      .array(z.string())
      .min(1, "Select at least one parcel type"),
    ...
    availabilityWindows: z
      .array(z.string())
      .min(1, "Select at least one time window"),
...
export default function AddTripV2() {
    ...
    <div className="mb-8">
      <div className="flex justify-between mb-2">
        {[1, 2, 3, 4, 5].map(step => (
          <div
            key={step}
            className={cn("flex items-center", step < 5 && "flex-1")}
          >
            <div
              className={cn(
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      {watchSpace > 0 &&
        Array.isArray(watchBagType) &&
        watchBagType.length > 0 && (
          <Alert>
            ...
            <AlertDescription>
              ...
              <p className="text-sm text-gray-600 mt-1">
                This is above average capacity - you'll likely get more match
                requests!
              </p>
            </AlertDescription>
          </Alert>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      ...
      {Array.isArray(watchAcceptableTypes) &&
        watchAcceptableTypes.includes("fragile") && (
          <Alert variant="destructive">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              Carrying fragile items requires extra care. Make sure you have
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          How flexible are you with pickup and delivery?
        </p>
      </div>
              ...
              {TIME_WINDOWS.map(window => (
                <div key={window.value} className="flex items-center space-x-2">
                  <input
                    ...
                    checked={
                      Array.isArray(field.value) &&
                      field.value.includes(window.value)
                    }
                    onChange={e => {
                      const currentValue = Array.isArray(field.value)
                        ? field.value
                      ...
                      if (e.target.checked) {
                        ...
                        field.onChange(
                          currentValue.filter(v => v !== window.value)
                        );
                      }
                    }}
                    className="rounded border-gray-300"
    ...
    return (
      <div className="space-y-6">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">
            Review your trip details and set pricing
          </p>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            Your trip will be published immediately and visible to senders.
            You'll receive match requests via email and in-app notifications.
          </AlertDescription>
        </Alert>
      </div>
    );
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <AnimatedCard
            variant="premium"
            className="p-8 text-center bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50"
          >
            <motion.div
            ...
            >
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl mb-6 shadow-xl">
                <Plane className="h-10 w-10 text-white" />
              </div>
              <h1 className="text-4xl font-bold mb-3 bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent">
                Add a Trip
              </h1>
              <p className="text-xl text-gray-700 font-medium">
                Help others by carrying their packages and earn money while you
                travel
              </p>
            </motion.div>
          </AnimatedCard>
