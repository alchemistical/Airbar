  ...
  const getTotalStats = () => {
    ...
    const avgRating =
      filteredRecords.length > 0
        ? filteredRecords.reduce((sum, r) => sum + r.travelerRating, 0) /
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Sender Package Records ({sortedRecords.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
