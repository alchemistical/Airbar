...
export default function ParcelRequestDetail() {
  ...
  const parcelRequest: ParcelRequestDetailType = {
    ...
    specialInstructions:
      "Please handle with extreme care. Contains confidential legal documents that must remain flat and dry. Pickup is available between 9 AM - 5 PM on weekdays. Delivery should be made to the reception desk on the 15th floor.",
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-small">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">
                        Weight: {parcelRequest.weight} kg
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <DollarSign className="h-4 w-4 text-gray-400" />
                      <span className="text-gray-600">
                        Reward: ${parcelRequest.rewardAmount}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-body text-airbar-black ml-5">
                      {parcelRequest.pickupAddress}
                    </p>
                  </div>
                ...
                <div className="space-y-3">
                  <h4 className="text-h5 font-medium text-airbar-black">
                    Important Dates
                  </h4>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-small text-gray-600">
                          {formatDate(parcelRequest.createdAt)}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-small text-red-600 font-medium">
                          {formatDate(parcelRequest.deadline)}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {parcelRequest.specialInstructions && (
                  <>
                    <Separator />
                    <div>
                      <h4 className="text-h5 font-medium text-airbar-black mb-2">
                        Special Instructions
                      </h4>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-small text-gray-600">
                        {formatDate(parcelRequest.tripDate!)} at{" "}
                        {parcelRequest.tripDepartureTime}
                      </p>
                    </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      <h3 className="text-h5 font-semibold text-airbar-black">
                        {parcelRequest.senderName}
                      </h3>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-small text-gray-600">
                          {parcelRequest.senderRating}
                        </span>
                      </div>
                      <span className="text-small text-gray-600">•</span>
                      <span className="text-small text-gray-600">
                        Member since{" "}
                        {new Date(parcelRequest.senderJoinDate).getFullYear()}
                      </span>
                    </div>
                  </div>
                </div>
