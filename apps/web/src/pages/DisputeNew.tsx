...
const reasonOptions = [
  {
    ...
    label: "Lost Package",
    icon: Package,
    description: "Package was not delivered",
  },
  {
    value: "damaged",
    label: "Damaged Item",
  ...
  },
  {
    ...
    label: "Late Delivery",
    icon: Clock,
    description: "Package delivered after deadline",
  },
  {
    value: "payment",
    label: "Payment Issue",
    icon: TrendingUp,
    description: "Problem with payment or refund",
  },
  {
    value: "other",
    label: "Other Issue",
    icon: AlertCircle,
    description: "Different type of problem",
  },
];
...
const outcomeOptions = [
  {
    value: "refund",
    label: "Full Refund",
    description: "Get your money back completely",
  },
  {
    value: "partial",
    label: "Partial Refund",
    description: "Get a portion of your payment back",
  },
  {
    value: "replacement",
    label: "Replacement",
    description: "Get a new item shipped",
  },
  {
    value: "other",
    label: "Other Resolution",
    description: "Suggest a different solution",
  },
];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Select the issue type that best describes your problem
        </p>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Please review your dispute details before submitting
        </p>
      </div>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              {watchedValues.reason && (
                <>
                  {reasonOptions.find(r => r.value === watchedValues.reason)
                    ?.icon && (
                    <div className="p-1.5 bg-gray-100 rounded">
                      {(() => {
                        const Icon = reasonOptions.find(
                          r => r.value === watchedValues.reason
                        )!.icon;
        ...
        <Card>
          ...
          <CardContent>
            <p className="font-medium">
              {
                outcomeOptions.find(
                  o => o.value === watchedValues.preferredOutcome
                )?.label
              }
            </p>
          </CardContent>
        ...
        <Card className="bg-amber-50 border-amber-200">
          ...
          <CardContent>
            <ul className="space-y-1 text-sm text-gray-700">
              <li>
                • The other party will be notified and given 48 hours to respond
              </li>
