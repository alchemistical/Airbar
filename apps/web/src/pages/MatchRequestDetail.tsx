...
export default function MatchRequestDetail() {
  ...
  const { data: request = mockRequest, isLoading } =
    useQuery<MatchRequestDetail>({
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600 mt-1">
                      ${request.reward} is held securely and will be released
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium flex items-center gap-2 mt-1">
                    <DollarSign className="h-4 w-4" />${request.reward}
                  </p>
                </div>
                <div>
            ...
            <div className="flex gap-3 pt-4">
              <Button className="flex-1">View Tracking</Button>
