...
export default function TravelerTrips() {
  ...
  const filteredTrips = trips?.filter(trip => {
    const matchesSearch = trip.fromCity.toLowerCase().includes(searchTerm.toLowerCase()) ||
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <Badge 
                          variant={trip.requestCount > 0 ? "default" : "secondary"}
                          className={trip.requestCount > 0 ? "bg-airbar-orange text-white" : ""}
                        >
          ...
          {(!filteredTrips || filteredTrips.length === 0) && (
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-h3 text-airbar-black mb-2">No trips found</h3>
