...
import { Package, MapPin, Calendar, Weight, DollarSign, AlertCircle, Clock, Shield } from "lucide-react";
...
export default function PaymentCheckout() {
      ...
      <DashboardLayout>
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-medium mb-2">Match request not found</h3>
  ...
  const acceptedTime = matchRequest.acceptedAt ? new Date(matchRequest.acceptedAt) : new Date();
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Pay securely to confirm your delivery with {matchRequest.travelerName}
            </CardDescription>
          </CardHeader>
        </Card>
        ...
        {timeRemaining > 0 && (
          <Alert>
            ...
            <AlertDescription>
              Complete payment within {minutesRemaining} minutes to secure this match
            </AlertDescription>
          </Alert>
        )}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">${(parseFloat(matchRequest.reward) * 0.05).toFixed(2)}</span>
            </div>
            <Separator />
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            disabled={isProcessing || createPaymentSessionMutation.isPending || timeRemaining === 0}
          >
