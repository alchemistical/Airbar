...
export default function Notifications() {
  ...
  const mockNotifications: Notification[] = [
    ...
    },
    {
      ...
      message: "Your identity verification has been approved. You can now carry higher value packages.",
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-h1 font-bold text-airbar-black">Notifications</h1>
            <p className="text-gray-600">Stay updated with your delivery activity and system alerts</p>
          </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{mockNotifications.length}</p>
                </div>
                        ...
                        <div className="flex items-start space-x-4 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-1">
                              <h3 className={`font-semibold ${!notification.isRead ? "text-airbar-black" : "text-gray-700"}`}>
                                {notification.title}
                              </h3>
                              {!notification.isRead && (
