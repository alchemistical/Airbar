...
export default function HistoryTraveler() {
  ...
  const getTotalStats = () => {
    ...
    const avgRating = filteredRecords.length > 0 
      ? filteredRecords.reduce((sum, r) => sum + r.senderRating, 0) / filteredRecords.length 
      : 0;
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-h1 font-bold text-airbar-black">Traveler Delivery History</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Avg Sender Rating</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Traveler Delivery Records ({sortedRecords.length})</CardTitle>
          </CardHeader>
          <CardContent>
            {sortedRecords.length === 0 ? (
              <div className="text-center py-12 text-gray-500">
                <Package className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <h3 className="text-lg font-medium mb-2">No traveler records found</h3>
                      ...
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-medium">{record.senderName}</span>
                            <div className="flex items-center">
                              <Star className="h-3 w-3 text-yellow-500 mr-1" />
                              <span className="text-xs text-gray-500">{record.senderRating}</span>
                            </div>
                          </div>
