...
export default function Referrals() {
  ...
  const totalEarned = mockReferrals.filter(r => r.isEarned).reduce((sum, r) => sum + r.bonusAmount, 0);
  const pendingEarnings = mockReferrals.filter(r => !r.isEarned).reduce((sum, r) => sum + r.bonusAmount, 0);
  ...
  const shareToSocial = (platform: string) => {
    const referralLink = `https://airbar.app/signup?ref=${referralCode}`;
    const message = "Join me on Airbar and earn money by delivering packages while traveling! Use my referral code to get started.";
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Earn $25 for every friend you refer who completes their first delivery</p>
          </div>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-600">{mockReferrals.length}</p>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className={`text-2xl font-bold ${
                          referral.isEarned ? "text-green-600" : "text-gray-400"
                        }`}>
