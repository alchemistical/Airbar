...
interface MatchRequest {
  ...
  category: string;
  message: string;
  status: "pending" | "accepted" | "paid" | "confirmed" | "in_transit" | "delivered" | "disputed" | "cancelled";
...
export default function MatchRequests() {
  ...
  if (matchId) {
    ...
    const canPay = isUserSender && match.status === "accepted" && match.paymentStatus === "pending";
    const showTracking = ["paid", "confirmed", "in_transit", "delivered"].includes(match.status);
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm bg-gray-50 p-3 rounded-lg">{match.message}</p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {canPay && (
                    <div className="space-y-3">
                      ...
                      <Button 
                        className="w-full" 
                        onClick={() => navigate(`/payment-checkout/${match.id}`)}
                      >
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-secondary mt-2">Manage your package delivery matches</p>
        </div>
                  ...
                  <CardContent className="space-y-3">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-primary">${match.reward}</p>
                      </div>
                    </div>
                    ...
                    {match.status === "accepted" && match.paymentStatus === "pending" && activeTab === "sender" && (
