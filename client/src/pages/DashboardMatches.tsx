...
export default function DashboardMatches() {
  ...
  const confirmPickupMutation = useMutation({
    mutationFn: async (data: { matchId: number; notes: string; photos?: File[] }) => {
  ...
  const filteredMatches = mockMatches.filter(match => 
    activeTab === "sender" ? match.senderId === userId : match.travelerId === userId
  );
  ...
  if (matchId) {
    ...
    const canConfirmPickup = !isUserSender && match.trackingStep === "picked_up" && !match.pickedUpAt;
    const canConfirmDelivery = isUserSender && match.trackingStep === "in_transit";
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <EscrowBanner 
            ...
            releaseDate={match.deliveredAt ? new Date(match.deliveredAt) : undefined}
          />
            ...
            <CardContent>
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="text-center">
                  ...
                  <p className="font-medium">
                    {match.trackingStep === "in_transit" || match.trackingStep === "delivered"
                      ? "Active"
                      : "—"}
                  </p>
                </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">{match.fromCity} → {match.toCity}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                        ...
                        <span>{format(new Date(match.departureDate), "MMM d, yyyy")}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm bg-gray-50 p-3 rounded-lg">{match.packageDescription}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <p className="font-mono font-bold text-lg">{match.pickupCode}</p>
                    </div>
                    <div className="bg-green-50 p-4 rounded-lg">
                      <p className="text-sm text-green-600 mb-1">Delivery Code</p>
                      <p className="font-mono font-bold text-lg">{match.deliveryCode}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {(match.pickupAddress || match.deliveryAddress) && (
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {match.pickupAddress && (
                      <div>
                        <p className="text-sm text-secondary mb-1">Pickup Address</p>
                        <p className="font-medium">{match.pickupAddress}</p>
                        {match.pickupTime && (
                          <p className="text-sm text-secondary mt-1">
                            Scheduled: {format(new Date(match.pickupTime), "MMM d, h:mm a")}
                          </p>
                        )}
                      </div>
                    )}
                    {match.deliveryAddress && (
                      <div>
                        <p className="text-sm text-secondary mb-1">Delivery Address</p>
                    ...
                    <Dialog open={showPickupModal} onOpenChange={setShowPickupModal}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Verify the pickup code and take photos of the package
                          </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                              ...
                              <p className="text-sm text-secondary">Upload photos</p>
                            </div>
                          </div>
                          <Button 
                            className="w-full"
                      ...
                      <DialogContent>
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                              <Camera className="h-8 w-8 mx-auto text-gray-400 mb-2" />
                              <p className="text-sm text-secondary">Upload proof of delivery</p>
                            </div>
                          </div>
                          <Button 
                            className="w-full"
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-secondary mt-2">Track and manage your confirmed deliveries</p>
        </div>
                ...
                <Card key={match.id} className="hover-lift">
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="font-medium">{match.fromCity} → {match.toCity}</h3>
                        <p className="text-sm text-secondary mt-1">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">{match.weight}kg - {match.category}</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-secondary">Reward</span>
                        <span className="font-medium text-primary">${match.reward}</span>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <p className="font-medium text-sm">
                            {activeTab === "sender" ? match.travelerName : match.senderName}
                          </p>
                          <div className="flex items-center space-x-1">
                            <Star className="h-3 w-3 text-yellow-500 fill-current" />
                            <span className="text-xs">
                              {activeTab === "sender" ? match.travelerRating : match.senderRating}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <div className="flex items-center justify-between text-xs">
                        <span className={match.trackingStep === "picked_up" ? "text-primary font-medium" : "text-gray-400"}>
                          Picked Up
                        </span>
                        <span className={match.trackingStep === "in_transit" ? "text-primary font-medium" : "text-gray-400"}>
                          In Transit
                        </span>
                        <span className={match.trackingStep === "delivered" ? "text-primary font-medium" : "text-gray-400"}>
                          Delivered
                        </span>
                      </div>
                      <div className="mt-2 h-1 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{
                            width: match.trackingStep === "picked_up" ? "33%" : 
                                   match.trackingStep === "in_transit" ? "66%" : 
                                   match.trackingStep === "delivered" ? "100%" : "0%"
                          }}
                        />
                      </div>
                    </div>
