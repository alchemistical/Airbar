...
import { registerSchema, loginSchema, forgotPasswordSchema, resetPasswordSchema } from '../../../shared/auth-validation';
import type { RegisterInput, LoginInput, ForgotPasswordInput, ResetPasswordInput } from '../../../shared/auth-validation';
...
interface AuthContextType {
  ...
  isLoading: boolean;
  login: (data: LoginInput) => Promise<{ success: boolean; needsOTP?: boolean; error?: string }>;
  register: (data: RegisterInput) => Promise<{ success: boolean; needsEmailVerification?: boolean; error?: string }>;
  logout: () => Promise<void>;
  forgotPassword: (data: ForgotPasswordInput) => Promise<{ success: boolean; error?: string }>;
  resetPassword: (data: ResetPasswordInput) => Promise<{ success: boolean; error?: string }>;
